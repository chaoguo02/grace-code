...
class EventType(str, Enum):
    ...
    DELEGATION_TASK_QUEUED = "delegation_task_queued"
    DELEGATION_TASK_STARTED = "delegation_task_started"
    DELEGATION_TASK_REPORTED = "delegation_task_reported"
    DELEGATION_TASK_FAILED = "delegation_task_failed"
    DELEGATION_TASK_BLOCKED = "delegation_task_blocked"
    DELEGATION_TASK_RETRYING = "delegation_task_retrying"
    DELEGATION_SYNTHESIS_STARTED = "delegation_synthesis_started"
    DELEGATION_PHASE_CHANGED = "delegation_phase_changed"
    DELEGATION_INTEGRATION_STARTED = "delegation_integration_started"
    DELEGATION_INTEGRATION_COMPLETED = "delegation_integration_completed"
    DELEGATION_VERIFICATION_STARTED = "delegation_verification_started"
    DELEGATION_VERIFICATION_COMPLETED = "delegation_verification_completed"
